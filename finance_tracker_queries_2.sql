...
-- This is your "category-wise spending" query.
-- It's more granular. Shows *where* the money
-- went each month.
-- ----------------------------------------------------
SELECT
    u.username,
...
-- This view uses the logic from Query 3 to create a
-- persistent, queryable "virtual table" for the
...
-- ----------------------------------------------------
-- How to use the View:
-- Now you can just run this simple query anytime
-- to get the full balance sheet.
-- ----------------------------------------------------
SELECT * FROM `v_monthly_financial_summary`;

-- You can also filter the view easily:
SELECT * FROM `v_monthly_financial_summary`
